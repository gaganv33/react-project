...
function CartItem({item}){
   return (
      <div className="flex flex-col items-start py-2 gap-1 sm:flex-row sm:items-center sm:justify-between sm:mx-auto sm:w-[70%] sm:py-3">
         ...
         <div className="flex items-center justify-between space-x-4 w-full sm:justify-end sm:w-[50%] text-sm sm:text-base">
            ...
            <button className="bg-yellow-500 rounded-full px-4 py-1 uppercase tracking-wider font-medium
             focus:outline-none focus:ring focus:ring-yellow-500 focus:ring-offset-2">Delete</button>
         </div>
      </div>
   );
}
